...
<div class="row form-row-wrapper">
    ...
    <form id="telesales7betReg" class="col s12" method="post" action="telesales/register/7bet">
        <div class="row">
...
<div id="popup_content_wrap" style='display:none'>
    <div id="popup_content">
        <center>
            ...
            <a id="confirmReg" href="https://secure.livechatinc.com/licence/1908802/v2/open_chat.cgi" class="confirm-reg">LANJUTKAN</a>
        </center>
    </div>
</div>
...
<noscript>
<a href="https://www.livechatinc.com/chat-with/1908802/" rel="nofollow">Chat with us</a>,
